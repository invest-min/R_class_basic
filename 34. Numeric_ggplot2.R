...
ggplot(df, aes(x=x, y=y)) +
  geom_point() +
  geom_smooth() +
  geom_text(label=f, hjust=0, vjust=0, nudge_x=.1, nudge_y=.1) +
  labs(x="xxx",
       y="yyy",
       title="Title",
       subtitle="Subtitle",
...
ggplot(df, aes(x=x, y=y)) +
  geom_point() +
  geom_smooth() +
  geom_text(label=f, hjust=0, vjust=0, nudge_x=.1, nudge_y=.1, size=4) +
  labs(x="xxx",
       y="yyy",
       title="Title",
       subtitle="Subtitle",
...
ggplot(df, aes(x=x, y=y)) +
  geom_point() +
  geom_smooth() +
  geom_text(label=f, hjust=0, vjust=0, nudge_x=.1, nudge_y=.1, size=5) +
  labs(x="xxx",
       y="yyy",
       title="Title",
       subtitle="Subtitle",
